...
*This document, with active hyperlinks, is available online at:*
...
1) Convert the point data to rasters for *Acer rubrum*, *Pinus strobus*, and *Prunus serotina* as explained below (in the section 'Creating Cells of Presence/Absence'), and plot them. Based on the plots, for which species do you expect to find significant aggregation? For which species do you expect to find significant dispersion? Justify your answers.
...
5) 4) Create and show plots for Moran's *I* and Geary's *c* for *Pinus strobus*. Does this species show significant autocorrelation? If so, at what distances?
...
7) Calculate Local Moran's *I* for a raster of the number of trees for *Acer rubrum*. Look at plots of those results and plots of the original data - are there distinct 'hotspots' of tree of this species? Circle them on your answer sheet (you can copy/paste the a result figure into Word and use drawing tools there to simply draw a circle around them). Hotspots are local areas that have higher number of trees within a cluster of a few pixels.
