...
2) Look at the points for a single individual on a map (you can do this in R or QGIS). Do you think the 95% Minimum Convex Polygon adequately descrbies the home range? Or do you think it characterizes it too broadly or too small? (Describe why) You can provide plots of the data and home ranges if that helps your point (but is not necessary).

3) Now look at a 95% Kernel Density Estimate with h="href" of the zebras' home ranges. Does this fit better or worse than the Minimum ConVex Polygon (justify your answer). You can provide plots of the data and home ranges if that helps your point (but is not necessary).
...
5) As you did for questions 2 and 3, look at home range estimates based on the 95% probbaility surface of the Brownian Bridge Movement Model. How does this appear to fit compared to the others? Explain your answer. You can provide plots of the data and home ranges if that helps your point (but is not necessary).
